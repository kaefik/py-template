...
@Gooey(program_name='Простой шаблон использования Gooey', 
    default_size=(900, 700), language='russian', dump_build_config=True)
def main():
    ...
    my_parser.add_argument('-flag1', metavar="Флаг1", action='store_true',
        help="включите Флаг1")
    my_parser.add_argument('username', help='username', 
        type=str, default="значение по умолчанию")
